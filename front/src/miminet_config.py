...
def make_example_net_switch_and_hub():
    return (
        ...
        ' "l2sw1_1","is_enabled": "1"},{"connect": "edge_lecsztzmmr9hg7nabv", "id": "l2sw1_2", "name":'
        ' "l2sw1_2","is_enabled": "1"},{"connect": "edge_lect0ujovtnu3vu4k9j", "id": "l2sw1_3", "name":'
        ' "l2sw1_3","is_enabled": "1"}],"position": {"x": 116.88900151787291, "y":'
        ...
        ' "l1hub1_1","is_enabled": "1"},{"connect": "edge_lecsztzmmr9hg7nabv", "id": "l1hub1_2", "name":'
        ' "l1hub1_2","is_enabled": "1"},{"connect": "edge_lecszwkj36zl99wxqto", "id": "l1hub1_3", "name":'
        ' "l1hub1_3","is_enabled": "1"}],"position": {"x": 229.5881438315644, "y":'
        ...
        ' 24,"is_enabled": "1"}],"position": {"x": 36.223748916284435, "y":'
        ...
        ' 24,"is_enabled": "1"},{"id": "iface_8674634", "name": "iface_8674634", "connect":'
        ' "edge_leodb0i042efyciiaci","is_enabled": "1"}],"position": {"x": 310.2812404364625, "y":'
        ...
        ' "iface_6176562","is_enabled": "1"}],"position": {"x": 305.92699885106083, "y":'
        ...
        ' 24,"is_enabled": "1"}],"position": {"x": 38.67780079395636, "y": 123.65267304098761}}],"edges":'
